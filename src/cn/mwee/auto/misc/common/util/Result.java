...
/** 操作结果公共类：<br>
 * 
 * {@link InternalTestResult#flag} - 结果状态标志 <br>
 * {@link InternalTestResult#value} - 结果值
 * 
 * */
public class Result<F extends Object, V extends Object>
{
	/** 获取一个 {@link InternalTestResult} 对象初始值：{{@link Boolean#FALSE}, null} */
	...
	/** 获取一个 {@link InternalTestResult} 对象初始值：{byte(0), null} */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	/** 获取一个 {@link InternalTestResult} 对象初始值：{char(0), null} */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	/** 获取一个 {@link InternalTestResult} 对象初始值：{short(0), null} */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	/** 获取一个 {@link InternalTestResult} 对象初始值：{int(0), null} */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	/** 获取一个 {@link InternalTestResult} 对象初始值：{long(0), null} */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	/** 获取一个 {@link InternalTestResult} 对象初始值：{{@link Double#NaN}, null} */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	/** 获取一个 {@link InternalTestResult} 对象初始值：{"", null} */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	/** 获取一个 {@link InternalTestResult} 对象初始值：{Date("1970-1-1 00:00:00"), null} */
	@SuppressWarnings({ "unchecked", "rawtypes" })
