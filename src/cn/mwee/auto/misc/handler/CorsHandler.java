...
import static org.jboss.netty.handler.codec.http.HttpHeaders.Names.ACCESS_CONTROL_EXPOSE_HEADERS;
import static org.jboss.netty.handler.codec.http.HttpHeaders.Names.ACCESS_CONTROL_MAX_AGE;
import static org.jboss.netty.handler.codec.http.HttpHeaders.Names.ACCESS_CONTROL_REQUEST_METHOD;
...
public class CorsHandler extends SimpleChannelHandler {
	 ...
	 *
	 * @param response
	 *            the HttpResponse to which the preflight response headers
	 *            should be added.
	 */
