...
public final class CorsConfig {
    ...
    public HttpHeaders preflightResponseHeaders() {
        ...
        for (Entry<CharSequence, Callable<?>> entry : this.preflightHeaders.entrySet()) {
            ...
            if (value instanceof Iterable) {
                preflightHeaders.add((String) entry.getKey(), (Iterable<?>) value);
            } else {
                preflightHeaders.add((String) entry.getKey(), value);
            }
        }
    ...
    public static class Builder {
        ...
        public CorsConfig build() {
            ...
            requestMethods.add(HttpMethod.POST);
            //requestMethods.add(HttpMethod.GET);
			
			requestHeaders.add("accept, content-type");
			//requestHeaders.add("x-requested-with");
