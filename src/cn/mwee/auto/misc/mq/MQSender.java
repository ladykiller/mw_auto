...
public class MQSender
{
	...
	public void send(String routingKey, Object message, MessagePostProcessor messagePostProcessor) throws AmqpException
	{
		template.convertAndSend(routingKey, message, messagePostProcessor);
	}
	
	public void send(String exchange, String routingKey, Object message, MessagePostProcessor messagePostProcessor) throws AmqpException
	{
	...
	@Async
	public void sendAsync(Object message, MessagePostProcessor messagePostProcessor) throws AmqpException
	{
		template.convertAndSend(message, messagePostProcessor);
	}
	
	@Async
	public void sendAsync(String routingKey, Object message, MessagePostProcessor messagePostProcessor) throws AmqpException
	{
		template.convertAndSend(routingKey, message, messagePostProcessor);
	}
	
	@Async
	public void sendAsync(String exchange, String routingKey, Object message, MessagePostProcessor messagePostProcessor) throws AmqpException
	{
		template.convertAndSend(exchange, routingKey, message, messagePostProcessor);
	}
